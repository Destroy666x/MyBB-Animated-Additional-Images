...
$l['animated_additional_images_posts'] = 'Włącz anonimowe dodatkowe grupy we wszystkich postach?';
$l['animated_additional_images_posts_desc'] = 'Ustaw na tak aby włączyć plugin w postach.';
$l['animated_additional_images_profile'] = 'Włącz anonimowe dodatkowe grupy we wszystkich profilach?';
$l['animated_additional_images_profile_desc'] = 'Ustaw na tak aby włączyć plugin w profilach.';
$l['animated_additional_images_memberlist'] = 'Włącz anonimowe dodatkowe grupy w liście użytkowików?';
$l['animated_additional_images_memberlist_desc'] = 'Ustaw na tak aby włączyć plugin w liście użytkowników.';
$l['animated_additional_images_announcements'] = 'Włącz anonimowe dodatkowe grupy we wszystkich ogłoszeniach?';
$l['animated_additional_images_announcements_desc'] = 'Ustaw na tak aby włączyć plugin w ogłoszeniach.';
$l['animated_additional_images_pms'] = 'Włącz anonimowe dodatkowe grupy we wszystkich prywatnych wiadomościach?';
$l['animated_additional_images_pms_desc'] = 'Ustaw na tak aby włączyć plugin w prywatnych wiadomościach.';
$l['animated_additional_images_previews'] = 'Włącz anonimowe dodatkowe grupy we wszystkich podglądach?';
